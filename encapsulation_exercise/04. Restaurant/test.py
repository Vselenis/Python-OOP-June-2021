from project1.food import starter
from project1.product import Product
from project1.beverage.beverage import Beverage
from project1.food.soup import Soup
from project1.food.food import Food
